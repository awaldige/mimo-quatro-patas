...
setErro("");
  ...
  console.error(
    "[Admin Produtos] Erro ao carregar:",
    error
  );
...
if (imagem.startsWith("/uploads/")) {
  return `${API_URL.replace("/api", "")}${imagem}`;
}
...
if (carregando) {
return ( <main className="min-h-screen bg-[#fffaf5] px-6 py-10"> <div className="mx-auto max-w-7xl"> <div className="rounded-3xl border border-[#eadfd6] bg-white px-6 py-16 text-center shadow-sm"> <div className="text-5xl">🐾</div>
...
if (erro) {
return ( <main className="min-h-screen bg-[#fffaf5] px-6 py-10"> <div className="mx-auto max-w-7xl"> <div className="rounded-3xl border border-red-200 bg-white px-6 py-16 text-center shadow-sm"> <div className="text-5xl">⚠️</div>
...
return ( <main className="min-h-screen bg-[#fffaf5] px-6 py-10"> <div className="mx-auto max-w-7xl">
{/* Cabeçalho */} <div className="flex flex-col justify-between gap-5 lg:flex-row lg:items-center"> <div> <Link
           href="/admin"
           className="text-sm font-semibold text-[#e58b6f] transition hover:text-[#c96d53]"
         >
← Voltar para administração </Link>
      ...
      {produtosFiltrados.length === 0 ? (
        ...
        <div className="divide-y divide-[#eadfd6]">
          {produtosFiltrados.map((produto) => {
            ...
            const promocao = possuiPromocao(produto);
            const precoAtual =
